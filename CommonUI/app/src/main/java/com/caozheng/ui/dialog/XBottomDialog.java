...
public class XBottomDialog extends Dialog {
    ...
    public static class BottomListSheetBuilder {
        ...
        /**
         * @param needRightMark 是否需要在被选中的 Item 右侧显示一个勾设置选中的 Item)
         */
        ...
        public BottomListSheetBuilder addItem(int imageRes, String textAndTag) {
            ...
            mItems.add(new BottomSheetListItemData(drawable, textAndTag, textAndTag));
            return this;
        }
        ...
        private boolean needToScroll() {
            int itemHeight = DisplayHelper.getAttrDimen(mContext, R.dimen.bottom_sheet_list_item_height);
            ...
            if (mTitleTv != null && !DisplayHelper.isNullOrEmpty(mTitle)) {
                totalHeight += DisplayHelper.getAttrDimen(mContext, R.dimen.bottom_sheet_list_item_height);
            }
        ...
        private class ListAdapter extends BaseAdapter {
            ...
            public View getView(final int position, View convertView, ViewGroup parent) {
                ...
                if (convertView == null) {
                    ...
                    holder.markView = convertView.findViewById(R.id.bottom_dialog_list_item_mark);
    ...
    public static class BottomGridSheetBuilder implements View.OnClickListener {
        ...
        public BottomGridSheetBuilder addItem(int imageRes, CharSequence text, Object tag, @Style int style, int subscriptRes) {
            LayoutInflater inflater = LayoutInflater.from(mContext);
            LinearLayout itemView = (LinearLayout) inflater.inflate(R.layout.bottom_sheet_grid_item, null, false);
        ...
        private View buildViews() {
            ...
            if (mBottomButton != null) {
                if (mIsShowButton) {
                    ...
                    int dimen = DisplayHelper.getAttrDimen(mContext, R.dimen.bottom_sheet_grid_padding_vertical);
